...
void handle_message(const std::string& message)
{
    ...
    try {
        ...
        case decrypty:
            ...
            break;
        case acc_not_found:
            MessageBoxA(0, "аккаунт не найден!", 0, MB_OK);
            break;
...
int main()
{
    ...
    ws = WebSocket::from_url("ws://45.143.94.218:8126/foo");
        ...
        ImGui::NewFrame();
        {
            if (true)
            {
                ...
                ImGui::Begin(iw.window_title, &active, iw.window_flags);
                {
                    ...
                    ImGui::TextDisabled("Loader base, made with <3 by lyrica");
                }
                ImGui::End();
            }
            else
